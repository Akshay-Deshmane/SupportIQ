    ...
    <div className="min-h-screen bg-zinc-50 text-zinc-900">
      ...
      <div className="flex justify-center px-4 py-14">
        ...
        >
            ...
            <h1 className="text-2xl font-semibold mb-2"> Embed Support IQ</h1>

            <p>Copy and paste this code before <code>&lt;/body&gt;</code></p>

            <div 
            className="relative bg-zinc-900 text-zinc-100 rounded-xl p-5 text-sm font-mono mb-10"
            >
            ...
            <div className="mt-14">
              ...
              <p className="text-sm text-zinc-500 mb-6">This is how the SupportIQ will appear on your website</p>

              <div className="rounded-xl border border-b-zinc-300 bg-white shadow-md overflow-hidden">
                ...
                <div className="relative h-64 sm:h-72 p-6 text-zinc-400 text-sm">
                  ...
                  <div className="absolute bottom-24d right-6 w-64 bg-white rounded-xl shadow-xl border-zinc-200 overflow-hidden"> 
