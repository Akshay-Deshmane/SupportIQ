...
const HomeClient = ({email} : {email : string}) => {
  ...
  const features = [
    ...
    {
      title : "Always Online",
      desc : "Your cutomers get instant support 24/7."
    }
  ]
  ...
  return (
    <div className='min-h-screen bg-linear-to-br from-white to-zinc-50 text-zinc-900 overflow-x-hidden'>
          ...
          <div className='max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 items-center'>
            ...
            >
              ...
              <h1 className='text-4xl md:text-5xl font-semibold leading-tight'>
                AI Cutomer Support-IQ <br/>
                Built For Modern Websites 
              </h1>

              <p className='mt-6 text-lg text-zinc-600 max-w-xl'>
                Add a powerful AI Chatbot (SupportIQ) to your websites in minutes.
            ...
            >
              ...
              <div className='rounded-2xl bg-white shadow-2xl border border-zinc-200 p-6'>
                ...
                <div className='space-y-3'>
                  ...
                  <div className='bg-zinc-100 rounded-lg px-4 text-sm w-fit'>
        ...
        <section 
        id='feature'
        className='bg-zinc-50 py-25 px-6 border-t border-zinc-200'
        >
          ...
          <div className='max-w-6xl mx-auto'>
            ...
            >
                 Why Busineses Choose SupportIQ
            </motion.h2>
        ...
        <footer className='py-10 text-center text-sm text-zinc-500'>
          &copy;{new Date().getFullYear()} SupportIQ. All rights are reserved to supportIQ.
        </footer>
